...
function BecomeTutor() {
    ...
    const Submit = async (e) => {
        e.preventDefault();
        try {
          const formData = { name, email, expertise, bio, courses, experience, education, location, contact, availability, image };
          await axios.post("http://localhost:8080/becomeTutor", formData);
          await axios.post("http://localhost:8080/updateUserRole", { email, role: 'tutor' });
